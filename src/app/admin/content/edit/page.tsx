...
import { Upload, X, Image as ImageIcon, Save, FileText, Video, Youtube, Loader2, ArrowLeft } from "lucide-react"
    ...
    useEffect(() => {
        const fetchArticle = async () => {
            ...
            if (data) {
                ...
                if (data.youtube_id) {
                    setYoutubeUrl(`https://www.youtube.com/watch?v=${data.youtube_id}`)
                }
            }
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 mt-1">Update your article content</p>
                    </div>
                </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="grid gap-6 lg:grid-cols-3">
                ...
                <div className="space-y-6">
                    ...
                    <Card className="border-gray-200 shadow-sm">
                        <CardHeader>
                            <CardTitle className="text-base font-semibold">Update</CardTitle>
                        </CardHeader>
